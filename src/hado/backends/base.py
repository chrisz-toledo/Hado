...
_BACKEND_REGISTRY: dict[str, dict] = {
    ...
    "c": {
        ...
        "class": "CTranspiler",
        "extension": ".c",
        "compile_cmd": "gcc -o output {path} -lcurl -lpcap",
    },
    "bash": {
        "version": "0.7",
        "status": "funcional",
        "description": "Living off the Land, shell scripting (curl, nc, dig)",
        "module": "hado.backends.bash_transpiler",
    ...
    "powershell": {
        "version": "0.7",
        "status": "funcional",
        "description": "Living off the Land, fileless Windows exploitation",
        "module": "hado.backends.powershell_transpiler",
